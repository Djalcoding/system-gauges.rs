...
use system_gauges::ui::{Configuration, colors::get_color_from_string};
...
use tui::{Terminal, backend::TermionBackend, style::Color, widgets::Borders};
...
";
    ...
    Ok(Configuration::new(
        color, disk_color, borders, background, text_color,
    ))
}
